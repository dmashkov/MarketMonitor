...
async function handler(request: Request): Promise<Response> {
  ...
  try {
    ...
    console.log(`Updating document ${requestData.document_id} with ${parseResult.text.length} chars`);
    ...
    console.log(`Successfully fetched and stored ${parseResult.text.length} chars`);
