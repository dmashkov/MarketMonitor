-- ============================================================================
-- Migration 011: Fix semantic search function return type
-- ============================================================================
-- Исправляем тип published_date с DATE на TIMESTAMPTZ
-- чтобы соответствовать типу в таблице documents
-- ============================================================================
